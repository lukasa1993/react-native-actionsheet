...
import { Text, View, Dimensions, Modal, TouchableHighlight, Animated, ScrollView, Easing, SafeAreaView, LayoutChangeEvent, Appearance, StyleSheet } from 'react-native'
  ...
  _createButton (title, index) {
    ...
    return (
      <TouchableHighlight
        ...
        style={[buttonBoxStyle, !(index == 0 || (cancelButtonIndex == 0 && index == 1)) && this._getBorderTopStyle()]}
